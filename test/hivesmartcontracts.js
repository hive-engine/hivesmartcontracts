...
describe('Smart Contracts', function ()  {
  ...
  it('should log an node error during the deployment of a smart contract if an error is thrown up to block 75656718', (done) => {
    new Promise(async (resolve) => {
      ...
      transactions.push(new Transaction(75656718, crashTx, CONSTANTS.HIVE_ENGINE_ACCOUNT, 'contract', 'deploy', JSON.stringify(contractPayload)));

      let block = {
        refHiveBlockNumber: 75656718,
        refHiveBlockId: 'ABCD1',
        prevRefHiveBlockId: 'ABCD2',
        timestamp: '2018-06-01T00:00:00',
        transactions,
  ...
  it('should log an custom error during the deployment of a smart contract if an error is thrown after block 75656718', (done) => {
    new Promise(async (resolve) => {
