...
it('it converts XXX to XXX.D', (done) => {
  new Promise(async (resolve) => {
   ...
   console.log( '\u001b[' + 93 + 'm' + 'Test: it converts XXX to XXX.D' + '\u001b[0m')
    console.log(" trans ...⚪", transactions[35])
       console.log(" logs...⚪",JSON.parse(transactionsBlock1[35].logs))
         console.log(" event0...⚪",JSON.parse(transactionsBlock1[35].logs).events[0])
            console.log(" event1...⚪",JSON.parse(transactionsBlock1[35].logs).events[1])
               console.log(" event2...⚪",JSON.parse(transactionsBlock1[35].logs).events[2])
  // console.log(token)
