...
describe('Market', function() {
  ...
  it('prevents small order exploits', (done) => {
    new Promise(async (resolve) => {
      ...
      const openOrders = await fixture.database.find({
        contract: 'market',
        table: 'openOrders',
        query: { }
      });
  ...
  it('market sells to multiple buyers', (done) => {
    new Promise(async (resolve) => {
      ...
      let openOrders = await fixture.database.find({
        contract: 'market',
        table: 'openOrders',
        query: { }
      });
      ...
      assert.strictEqual(openOrders[0].orderCount, 2);
      ...
      openOrders = await fixture.database.find({
        contract: 'market',
        table: 'openOrders',
        query: { }
      });
      ...
      assert.strictEqual(openOrders[0].orderCount, 0);
      assert.strictEqual(openOrders[1].orderCount, 0);
  ...
  it('creates buy orders with expirations', (done) => {
    new Promise(async (resolve) => {
      ...
      assert.strictEqual(openOrders.length, 1);
      assert.strictEqual(openOrders[0].orderCount, 3);
  ...
  it('generates error when trying to create a buy order with wrong parameters', (done) => {
    new Promise(async (resolve) => {
      ...
      assert.strictEqual(openOrders.length, 0);
  ...
  it('creates a sell order', (done) => {
    new Promise(async (resolve) => {
      ...
      assert.strictEqual(openOrders[0].orderCount, 4);
  ...
  it('buys from the market from several sellers', (done) => {
    new Promise(async (resolve) => {
      ...
      assert.strictEqual(openOrders.length, 3);
      assert.strictEqual(buyOrders.length, 0);
      assert.strictEqual(sellOrders.length, 0);
      assert.strictEqual(openOrders[0].orderCount, 0);
      assert.strictEqual(openOrders[1].orderCount, 0);
      assert.strictEqual(openOrders[2].orderCount, 0);
  ...
  it('buys from the market partially', (done) => {
    new Promise(async (resolve) => {
      ...
      assert.strictEqual(openOrders.length, 4);
      assert.strictEqual(openOrders[0].orderCount, 0);
      assert.strictEqual(openOrders[1].orderCount, 1);
      assert.strictEqual(openOrders[2].orderCount, 0);
      assert.strictEqual(openOrders[3].orderCount, 0);
  ...
  it('removes an expired sell order', (done) => {
    new Promise(async (resolve) => {
      ...
      assert.strictEqual(openOrders.length, 2);
      assert.strictEqual(sellOrders.length, 0);
      assert.strictEqual(openOrders[0].orderCount, 1);
      assert.strictEqual(openOrders[1].orderCount, 0);
  ...
  it('prevent creation of more than allowed orders', (done) => {
    new Promise(async (resolve) => {
      ...
      assert.strictEqual(openOrders[0].orderCount, 200);
      ...
      assert.strictEqual(openOrders[0].orderCount, 198);
