...
*/
  it('market sells to multiple buyers', async () => {
     ...
     assert.equal(res.transactions[0].logs, '{"events":[{"contract":"tokens","event":"transferToContract","data":{"from":"satoshi","to":"market","symbol":"TKN","quantity":"80.001"}},{"contract":"tokens","event":"transferFromContract","data":{"from":"market","to":"vitalik","symbol":"TKN","quantity":"10.000"}},{"contract":"tokens","event":"transferFromContract","data":{"from":"market","to":"satoshi","symbol":"SWAP.HIVE","quantity":"7.34000000"}},{"contract":"market","event":"orderClosed","data":{"account":"vitalik","type":"buy"}},{"contract":"tokens","event":"transferFromContract","data":{"from":"market","to":"aggroed","symbol":"TKN","quantity":"20.000"}},{"contract":"tokens","event":"transferFromContract","data":{"from":"market","to":"satoshi","symbol":"SWAP.HIVE","quantity":"12.68000000"}},{"contract":"market","event":"orderClosed","data":{"account":"aggroed","type":"buy"}},{"contract":"tokens","event":"transferFromContract","data":{"from":"market","to":"vitalik","symbol":"TKN","quantity":"30.000"}},{"contract":"tokens","event":"transferFromContract","data":{"from":"market","to":"satoshi","symbol":"SWAP.HIVE","quantity":"16.02000000"}},{"contract":"market","event":"orderClosed","data":{"account":"vitalik","type":"buy"}},{"contract":"tokens","event":"transferFromContract","data":{"from":"market","to":"aggroed","symbol":"TKN","quantity":"20.001"}},{"contract":"tokens","event":"transferFromContract","data":{"from":"market","to":"satoshi","symbol":"SWAP.HIVE","quantity":"8.68043400"}},{"contract":"market","event":"orderClosed","data":{"account":"satoshi","type":"sell","txId":"TXID00000014"}}]}'); 
  });
/*
