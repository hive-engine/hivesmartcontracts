...
describe('stopspam', function () {
  ...
  it('updates parameters', (done) => {
    new Promise(async (resolve) => {
      ...
      transactions.push(new Transaction(refBlockNumber, fixture.getNextTxId(), CONSTANTS.HIVE_ENGINE_ACCOUNT, 'stopspam', 'removeAccount', '{ "allowList": ["gus"] , "denyList": ["god2"] }'))
      let block = {
      ...
      console.log("26  ⚪",JSON.parse(transactionsBlock1[6].logs))
      console.log(params);
